...
def seevinck_read_snm_analysis():
    ...
    data_table = {
        'w_ax [m]': w_ax_seevinck_read,
        'snm(read)_max_seevinck [mV]': snm_max_seevinck_read,
        'snm(read)_min_seevinck [mV]': snm_min_seevinck_read
    }
    table_creation(
        data_table=data_table,
        title_plot="Comparative Analysis W_AX-SNM(READ)_MAX-SNM(READ)_MIN Seevinck Method",
        title_image_saving="table_comparative_wax_snm_max_min_read_seevinck.png",
        figsize=[18, 4]
    )
